...
import EquationVisual from '../shared/EquationVisual.jsx';
...
export default function QuestionRenderer({
  ...
  const categoryTag = category || 'ALGEBRA EQUATION';
  ...
  return (
    <div className="qr-wrap glass-card anim-slide-up">
      ...
      {/* Question text */}
      <p className="qr-question" style={{ whiteSpace: 'pre-line' }}>{questionText}</p>

      {/* Visual aid if available */}
      {visual && visualData && (
        <div className="qr-visual">
          <EquationVisual type={visual} data={visualData} compact={true} />
        </div>
      )}
